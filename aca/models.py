...
class Service:
    def __init__(self, recipient_keys: str, service_endpoint: str, routing_keys: str = None):
...
class PresentationFactory:
    ...
    @classmethod
    def from_params(cls, presentation_request: dict, p_id: str, verkey: [str], endpoint: str):
    ...
    def from_json(cls, presentation_request: dict):
        presentation = PresentationFactory.presentation_schema.load(presentation_request)
        return cls(presentation)
